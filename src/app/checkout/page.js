...
export default function CheckoutPage() {
  ...
  const handleConfirmOrder = async () => {
    ...
    try {
      ...
      console.log(
        "✅ Order data with payment details:",
      ...
      if (response.ok && result.success) {
        ...
        if (result.errors && Array.isArray(result.errors)) {
          ...
          const errorMsg =
            result.error || result.message || "Failed to place order";
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12 flex items-center justify-center px-4">
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 max-w-md w-full text-center">
          ...
          <h2 className="text-sm text-gray-600 mb-2 uppercase tracking-wide">
            Thank You
          </h2>
