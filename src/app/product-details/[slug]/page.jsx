                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p className="text-gray-600">
                      Category: <Link href={`/categories/${createSlug(product.category?.[0] || '')}`} className="text-orange-600 hover:underline font-medium">
              ...
              {activeTab === 'description' && (
                <div>
                  ...
                  {product.specification && (
                    <>
                      <h4 className="text-lg font-semibold text-gray-900 mb-4 mt-6">Specification</h4>
                  ...
                  {!product.description && !product.specification && (
                    <p className="text-gray-500 italic">No product description available.</p>
                  )}
                </div>
              )}
                  ...
                  return (
                    ...
                    >
                      <div className="w-10 h-10 bg-gray-100 rounded flex items-center justify-center text-gray-600 group-hover:bg-orange-100 group-hover:text-orange-600">
                        <span className="text-sm font-bold">{category.charAt(0)}</span>
                      </div>
