...
export default function FlashSale() {
  ...
  // Scroll left function - responsive scroll distance
  const scrollLeft = () => {
  ...
  // Scroll right function - responsive scroll distance
  const scrollRight = () => {
    if (scrollContainerRef.current) {
      const scrollAmount = scrollContainerRef.current.offsetWidth * 0.8;
      scrollContainerRef.current.scrollBy({
            ...
            >
              ...
              <div className="p-3 md:p-4">
                ...
                <div className="flex gap-1.5 md:gap-2">
                  <button className="flex-1 bg-orange-500 hover:bg-orange-600 text-white text-[10px] md:text-sm font-medium py-1.5 md:py-2 px-2 md:px-4 rounded transition-colors duration-300">
                    Buy Now
                  </button>
                  <button className="flex-1 bg-white hover:bg-gray-50 text-orange-500 border border-orange-500 text-[10px] md:text-sm font-medium py-1.5 md:py-2 px-2 md:px-4 rounded transition-colors duration-300">
                    Add to cart
                  </button>
                </div>
              </div>
